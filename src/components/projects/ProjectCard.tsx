...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <Card 
      className="w-full group cursor-pointer relative overflow-hidden transition-all duration-500 ease-out hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 hover:scale-[1.02] border-2 hover:border-purple-300/50 dark:hover:border-purple-600/50"
