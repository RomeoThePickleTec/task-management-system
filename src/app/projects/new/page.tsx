...
const NewProjectPage = () => {
  ...
  const handleCreateProject = async (projectData: Omit<IProject, 'id' | 'created_at' | 'updated_at'>) => {
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete los detalles para crear un nuevo proyecto. Los campos marcados con * son obligatorios.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ProjectForm
